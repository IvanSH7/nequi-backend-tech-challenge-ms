...
public class QueryEventsController {
    ...
    public Mono<ServerResponse> execute(String requestId) {
        return HandlerValidator.validateQueryEvents(requestId)
                ...
                .switchIfEmpty(Mono.defer(() -> buildResponse(Operation.QUERY_EVENTS, GeneralMessage.SUCCESS, requestId, MAPPER.toQueryEventsDataResponse(""))));
    }
